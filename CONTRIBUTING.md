...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/llamasearch-pdf.git
   cd llamasearch-pdf
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/llamasearch-pdf.git
   ```
...
By contributing to LlamaSearch Pdf, you agree that your contributions will be licensed under the project's MIT License.
