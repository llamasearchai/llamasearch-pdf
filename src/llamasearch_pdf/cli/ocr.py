...
from ..ocr import get_available_engines, ocr_image, ocr_pdf, process_directory
...
def list_engines_command(args):
    ...
    if not engines:
        console.print(
            "[yellow]  No OCR engines available. Please install one of:[/yellow]"
        )
...
def main(argv: Optional[List[str]] = None) -> int:
    ...
    list_parser = subparsers.add_parser(
        "list-engines", help="List available OCR engines"
    )
    ...
    dir_parser = subparsers.add_parser(
        "directory", help="Process all PDFs and images in a directory"
    )
    ...
    dir_parser.add_argument(
        "--extensions", help="Comma-separated list of file extensions to process"
    )
